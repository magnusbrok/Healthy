...
public class MonthNutrition extends Fragment implements View.OnClickListener, Observer {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nutritionDataMonth.add(new SliceValue(35, ContextCompat.getColor(getContext(), R.color.colorPrimary)));
